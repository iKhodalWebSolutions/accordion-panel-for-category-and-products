		...
		<td>  
			<div class="cls-row-item">							
				<div class="cls-row-item-field">
					<input <?php echo (( isset($fields[$key]["pm"]) && $fields[$key]["pm"] == 1 && $fields["st"]["flag"] != "valid"  )?"disabled='disabled'":""); ?> type="text" id="<?php echo $this->get_field_id( $key ); ?>" name="<?php echo $this->get_field_name( $key ); ?>" class="<?php echo esc_attr($fields[$key]["class"]); ?> rwapcp_field rwapcp_field_text is_required_<?php echo esc_attr( $fields[$key]["is_required"] ); ?> <?php echo (( isset($fields[$key]["pm"]) && $fields[$key]["pm"] == 1 && $fields["st"]["flag"] != "valid"  )?"fld_disabled":""); ?>" value="<?php echo   $default_val ; ?>" />
					<?php
...
<tr>
	...
	<td>
		<div class="cls-row-item">							
			<div class="cls-row-item-field">
				<input <?php echo (( isset($fields[$key]["pm"]) && $fields[$key]["pm"] == 1 && $fields["st"]["flag"] != "valid"  )?"disabled='disabled'":""); ?> type="text" id="id_rwapcp_<?php echo esc_attr( $key ); ?>" name="nm_<?php echo esc_attr( $key ); ?>" class="rwapcp_field rwapcp_field_text is_required_<?php echo esc_attr( $fields[$key]["is_required"] ); ?> <?php echo (( isset($fields[$key]["pm"]) && $fields[$key]["pm"] == 1 && $fields["st"]["flag"] != "valid"  )?"fld_disabled":""); ?>" value="<?php echo   $default_val ; ?>" />
				<?php
					if( isset($fields[$key]["pm"]) && $fields[$key]["pm"] == 1 && $fields["st"]["flag"] != "valid" ) {
						?>
							<p>
